...
<!-- Mirrored from minia.django.themesbrand.com/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2010], Mon, 08 Nov 2021 08:03:57 GMT -->
<head>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Register Account</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mb-3">
                                                <label for="Email_Address" class="form-label">{{ __('User Category') }}</label>
                                                <select class="form-control form-select" required name="User_Category">
...
<!-- Mirrored from minia.django.themesbrand.com/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2010], Mon, 08 Nov 2021 08:03:58 GMT -->
</html>